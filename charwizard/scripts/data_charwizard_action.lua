...
parsedata = {
	...
	["martialarts"] = {
		actions = {
			{ type = "attack", range = "M", stat = "dexterity", prof = true, },
	...
	["intuitivemotion"] = {
		actions = {
			{ type = "effect", sName = "Intuitive Motion; SKILL: 1d4 athletics", sTargeting = "self" }, { type = "effect", sName = "Intuitive Motion; SKILL: 1d4", sTargeting = "self", sApply ="action" },
		},
	},
	...
	["shiftingfeature"] = {
		multiple_actions = {
			["Shifting Feature (Beasthide)"] = {
				actions = {
					{ type = "heal", subtype = "temp", sTargeting = "self", clauses = { { dice = { "d6" }, }, }, },
					{ type = "effect", sName = "Shifting Feature (Beastside); AC: 1", sTargeting = "self", nDuration = 1, sUnits = "minute" },
				},
			},
	...
	["animalenhancement"] = {
		multiple_actions = {
			...
			["Animal Enhancement (Grappling Appendages)"] = {
				actions = {
					{ type = "effect", sName = "Animal Enh. (Grappling Appendages); Grappled", },
...
tBuildDataClass2024 = {
	...
	["soulofartifice"] = {
		multiple_actions = {
			["Cheat Death"] = {
				actions = {
					{ type = "heal", sTargeting = "self", clauses = { { dice = {}, bonus = 20, }, }, }
				},
			},
		},
	},
	...
	["experimentalelixerl3"] = {
		multiple_actions = {
			["Healing (Experimental Elixer L3)"] = {
				actions = {
					{ type = "heal", clauses = { { dice = { "d8", "d8" }, stat = "intelligence" }, }, },
					{ type = "heal", clauses = { { dice = { "d8", "d8", "d8" }, stat = "intelligence" }, }, },
					{ type = "heal", clauses = { { dice = { "d8", "d8", "d8", "d8" }, stat = "intelligence" }, }, },
				},
			},
			...
			["Resilience (Experimental Elixer L3)"] = {
				actions = {
					{ type = "effect", sName = "Resilience (Experimental Elixer); AC: 1", nDuration = 1, sUnits = "minutes", },
					{ type = "effect", sName = "Resilience (Experimental Elixer); AC: 1", nDuration = 1, sUnits = "hour", },
					{ type = "effect", sName = "Resilience (Experimental Elixer); AC: 1", nDuration = 8, sUnits = "hour", },
				},
			},
	...
	["toolsofthetradealchemist"] = {
		toolprof = { innate = { "Alchemist's Supplies", "Herbalism Kit" }, },
	},
	["alchemicalsavant"] = {
		{ type = "effect", sTargeting = "self", sName = "Alchemical Savant; HEAL: 1; DMG: 1", sApply = "roll" },
		{ type = "effect", sTargeting = "self", sName = "Alchemical Savant; HEAL: [INT]; DMG: [INT]", sApply = "roll" },
	},
	["alchemistspellsl5"] = {
		spells = {
			{ name = "Flaming Sphere" },
	...
	["chemicalmastery"] = {
		multiple_actions = {
			["Alchemical Eruption (Chemical Mastery)"] = {
				actions = {
					{ type = "damage", clauses = { { dice = { "d8", "d8" }, type = "force", }, }, },
				},
			},
			["Chemical Resistance (Chemical Mastery)"] = {
				actions = {
					{ type = "effect", sName = "Chemical Resistance (Chemical Mastery); RESIST: acid, poison; IMMUNE: poisoned", sTargeting = "self", }
				},
			},
			["Conjured Cauldron (Chemical Mastery)"] = {
				spells = {
	...
	["armorerspellsl3"] = {
		spells = {
			{ name = "Magic Missile" },
			{ name = "Thunderwave" },
			["group"] = "Spells (Armorer)",
			["ability"] = "intelligence",
		},
	},
	["toolsofthetradearmorer"] = {
		armorprof = { innate = { "Heavy", }, },
		toolprof = { innate = { "Smith's Tools" }, choice = 1, choice_prof = { "Artisan's Tools" }, },
	},
	["armorerspellsl5"] = {
		spells = {
			{ name = "Mirror Image" },
	...
	["artilleristspellsl3"] = {
		spells = {
			{ name = "Shield" },
			{ name = "Thunderwave" },
			["group"] = "Spells (Artillerist)",
			["ability"] = "intelligence",
		},
	},
	["eldritchcannon"] = {
		actions = {
			{ type = "effect", sName = "Eldritch Cannon", sTargeting = "self", nDuration = 1, sUnits = "hour", }
		},
		prepared = 1,
		usesperiod = "enc",
	},
	["toolsofthetradeatillerist"] = {
		weaponprof = { innate = { "Martial Ranged", }, },
		toolprof = { innate = { "Woodcarver's Tools" }, choice = 1, choice_prof = { "Artisan's Tools" }, },
	},
	["artilleristspellsl5"] = {
		spells = {
			{ name = "Scorching Ray" },
	...
	["arcanefirearm"] = {
		actions = {
			{ type = "effect", sName = "Arcane Firearm; DMG: 1d8", sTargeting = "self", }
		},
		prepared = 1,
		usesperiod = "enc",
	},
	...
	["explosivecannon"] = {
		multiple_actions = {
			["Detonate (Explosive Cannon)"] = {
				actions = {
					{ type = "powersave", save = "dexterity", savestat = "spell", onmissdamage = "half" },
					{ type = "damage", clauses = { { dice = { "d10", "d10", "d10" }, type = "force", }, }, },
				},
			},
		},
	},
	["artilleristspellsl13"] = {
		spells = {
			{ name = "Ice Storm" },
			{ name = "Wall of Fire" },
			["group"] = "Spells (Artillerist)",
	...
	["fortifiedposition"] = {
		multiple_actions = {
			["Shimmering (Fortified Position)"] = {
				actions = {
					{ type = "effect", sName = "Shimmering (Fortified Position); HCOVER", },
				},
			},
		},
	},
	["artilleristspellsl17"] = {
		spells = {
			{ name = "Cone of Cold" },
			{ name = "Wall of Force" },
			["group"] = "Spells (Artillerist)",
	...
	["battlesmithspellsl3"] = {
		spells = {
			{ name = "Heroism" },
			{ name = "Shield" },
			["group"] = "Spells (Battle Smith)",
			["ability"] = "intelligence",
		},
	},
	["toolsofthetradebattlesmith"] = {
		toolprof = { innate = { "Smith's Tools" }, choice = 1, choice_prof = { "Artisan's Tools" }, },
	},
	["battleready"] = {
		weaponprof = { innate = { "Martial" }, },
	...
	["arcanejolt"] = {
		multiple_actions = {
			["Destructive Energy (Arcane Jolt)"] = {
				actions = {
					{ type = "damage", clauses = { { dice = { "d6", "d6", }, type = "force", }, }, },
				},
			},
			["Restorative Energy (Arcane Jolt)"] = {
				actions = {
					{ type = "heal", clauses = { { dice = { "d6", "d6" }, }, }, },
				},
				prepared = 1,
	...
	["improveddefender"] = {
		multiple_actions = {
			["Improved Jolt (Improved Defender)"] = {
				actions = {
					{ type = "damage", clauses = { { dice = { "d6", "d6", "d6", "d6", }, type = "force", }, }, },
					{ type = "heal", clauses = { { dice = { "d6", "d6", "d6", "d6", }, }, }, },
				},
			},
			["Improved Deflection (Improved Defender)"] = {
				actions = {
					{ type = "damage", clauses = { { dice = { "d6", }, type = "force", stat = "intelligence" }, }, },
				},
			},
		},
	},
	["battlesmithspellsl17"] = {
		spells = {
	...
	-- Cartographer
	["cartographerspellsl3"] = {
		spells = {
			{ name = "Faerie Fire" },
			{ name = "Guiding Bolt" },
			{ name = "Healing Word" },
			["group"] = "Spells (Cartographer)",
			["ability"] = "intelligence",
		},
	},
	["toolsofthetradecartographer"] = {
		toolprof = { innate = { "Caligrapher's Tools" }, choice = 1, choice_prof = { "Artisan's Tools" }, },
	},
	["adventurersatlas"] = {
		multiple_actions = {
			["Awareness (Adventurer's Atlas)"] = {
				actions = {
					{ type = "effect", sName = "Awareness (Adventurer's Atlas); INIT: 1d4", },
				},
			},
		},
	},
	...
	["guidedprecision"] = {
		actions = {
			{ type = "effect", sTargeting = "self", sName = "Guided Precision; ATK: [INT]; DMG: [INT]", },
		},
	},
	["cartographerspellsl5"] = {
		spells = {
			{ name = "Locate Object" },
			{ name = "Mind Spike" },
			["group"] = "Spells (Cartographer)",
	...
	["superioratlas"] = {
		multiple_actions = {
			["Safe Haven (Superior Atlas)"] = {
				actions = {
					{ type = "heal", clauses = { { dice = {}, statmult = 2 , stat = "artificer" }, }, },
				},
			},
		},
		spells = {
			{ name = "Find the Path" },
			["group"] = "Spells (Superior Atlas)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	},
	["cartographerspellsl17"] = {
		spells = {
			{ name = "Scrying" },
	...
	["moonsinspiration"] = {
		multiple_actions = {
			["Inspired Eclipse"] = {
				actions = {
					{ type = "effect", sName = "Inspired Eclipse (Moon's Inspiration); Invisible", sTargeting = "self", nDuration = 1, sApply = "action" },
				},
			},
			["Lunar Vitality"] = {
				actions = {
	...
	["primallore"] = {
		...
		skill = { choice = 1, choice_skill = { "Animal Handling", "Insight", "Medicine", "Nature", "Perception", "Survival" } },
	},
	["blessingofmoonlight"] = {
		spells = {
			{ name = "Moonbeam" },
		...
		actions = {
			{ type = "effect", sName = "Blessings of Moonlight; LIGHT: 5 candle", sTargeting = "self" },
	...
	["blessedstrikespotentspellcasting"] = {
		multiple_actions = {
			["Potent Spellcasting"] = {
				actions = {
					{ type = "effect", sName = "Potent Spellcasting; DMG: [WIS]", sTargeting = "self", sApply = "roll", nDuration = 1, },
				},
			},
		},
	},
	...
	["divineforeknowledge"] = {
		actions = {
			{ type = "effect", sName = "Divine Foreknowledge; ADV", sTargeting = "self" },
		},
		prepared = 1,
		usesperiod = "enc",
	},
	...
	["maneuverrally"] = {
		multiple_actions = {
			["Rally"] = {
				actions = {
					{ type = "heal", subtype = "temp", clauses = { { dice = { "d8" }, statmult = 0.5, stat = "fighter" }, }, },
				},
				group = "Combat Superiority (Fighter)",
				ability = "strength",
			},
	...
	["knightlyenvoy"] = {
		spells = {
			{ name = "Comprehend Languages", ritual = true, },
			["group"] = "Spells (Banneret)",
			["ability"] = "charisma",
		},
		language = { choice = 1 },
		skill = { choice = 1, choice_skill = { "Insight", "Intimidation", "Persuasion", "Performance" } },
	},
	["teamtactics"] = {
		actions = {
	...
	["livinglegend"] = {
		actions = {
			{
				type = "effect",
				sName = "Living Legend; ADVCHECK: charisma; NOTE: Reaction to reroll failed Saves; NOTE: 1/turn - change Attack miss to a hit",
				sTargeting = "self",
				nDuration = 10,
				sUnits = "minute",
			},
	...
	["elementalsmite"] = {
		multiple_actions = {
			["Dao's Crush"] = {
				actions = {
					{ type = "effect", sName = "Dao's Crush (Elemental Smite); Grappled; Restrained" },
				},
			},
			["Djinni's Escape"] = {
				actions = {
					{ type = "effect", sName = "Djinni's Escape (Elemental Smite); RESIST: bludgeoning, piercing, slashing; IMMUNE: grappled, prone, restrained" },
				},
			},
			["Efreeti's Fury"] = {
				actions = {
	...
	["geniessplendor"] = {
		-- Add unarmored option AC = 10 + Dex and Con even with shield
		skill = { choice = 1, choice_skill = { "Acrobatics", "Intimidation", "Performance", "Persuasion" } },
	},
	["geniespellsl5"] = {
		spells = {
			{ name = "Mirror Image" },
	...
	["relentlesshunter"] = {
		actions = {
			{ type = "effect", sName = "HuntersMark", nDuration = 1, sUnits = "hour" },
			{ type = "effect", sName = "IFT: CUSTOM(HuntersMark); DMG: 1d6 force", sTargeting = "self", nDuration = 1, sUnits = "hour" },
		},
		group = "Hunter's Mark (Ranger)",
		ability = "wisdom",
	},
	...
	["precisehunter"] = {
		actions = {
			{ type = "effect", sName = "HuntersMark", nDuration = 1, sUnits = "hour" },
			{ type = "effect", sName = "IFT: CUSTOM(HuntersMark); ADVATK; DMG: 1d6 force", sTargeting = "self", nDuration = 1, sUnits = "hour" },
		},
		group = "Hunter's Mark (Ranger)",
		ability = "wisdom",
	},
	...
	["foeslayer"] = {
		actions = {
			{ type = "effect", sName = "HuntersMark", nDuration = 1, sUnits = "hour" },
			{ type = "effect", sName = "IFT: CUSTOM(HuntersMark); ADVATK; DMG: 1d10 force", sTargeting = "self", nDuration = 1, sUnits = "hour" },
		},
		group = "Hunter's Mark (Ranger)",
		ability = "wisdom",
	},
	...
	["frigidexplorer"] = {
		multiple_actions = {
			["Frost Resistance"] = {
				actions = {
					{ type = "effect", sName = "Frost Resistance; RESIST: cold", sTargeting = "self" },
				},
			},
			["Polar Strikes"] = {
				actions = {
					{ type = "damage", clauses = { { dice = { "d4" }, dmgtype = "cold", }, }, },
					{ type = "damage", clauses = { { dice = { "d6" }, dmgtype = "cold", }, }, },
				},
			},
		},
	...
	["huntersrime"] = {
		actions = {
			{ type = "heal", subtype = "temp", clauses = { { dice = { "d10" }, stat = "ranger" }, }, },
		},
	},
	["winterwalkerspells"] = {
		spells = {
	...
	["chillingretribution"] = {
		actions = {
			{ type = "powersave", save = "wisdom", savestat = "wisdom", },
			{ type = "effect", sName = "Chilling Retribution; Stunned", },
		},
		prepared = 1,
		usesperiod = "enc",
	},
	["winterwalkerspellsl13"] = {
		spells = {
			{ name = "Ice Storm" },
			["group"] = "Spells (Ranger)",
			["ability"] = "wisdom",
	...
	["frozenhaunt"] = {
		multiple_actions = {
			["Frozen Soul (Frozen Haunt)"] = {
				actions = {
					{ type = "effect", sName = "Frozen Soul; IMMUNE: cold", sTargeting = "self" },
					{ type = "damage", clauses = { { dice = { "d4", "d4" }, dmgtype = "cold", }, }, },
				},
			},
	...
	["dreadallegiance"] = {
		spells = {
			...
			{ name = "Blade Ward" },
			{ name = "Chill Touch" },
			["group"] = "Spells (Scion of Three)",
			["ability"] = "intelligence",
		},
		multiple_actions = {
			["Bane"] = {
				actions = {
					{ type = "effect", sName = "Bane; RESIST: psychic", sTargeting = "self" },
				},
			},
			["Bhaal"] = {
				actions = {
					{ type = "effect", sName = "Bhaal; RESIST: poison", sTargeting = "self" },
				},
			},
			["Myrkul"] = {
				actions = {
					{ type = "effect", sName = "Myrkul; RESIST: necrotic", sTargeting = "self" },
				},
			},
		},
	},
	["strikefear"] = {
		multiple_actions = {
			["Terrify (Strike Fear) (Cost: 1d6)"] = {
				actions = {
					{ type = "powersave", save = "wisdom" },
					{ type = "effect", sName = "Terrify (Strike Fear); Frightened", nDuration = 1, sUnits = "minute", },
				},
			},
		},
	},
	...
	["empoweredevocation"] = {
		actions = {
			{ type = "effect", sName = "Empowered Evocation; DMG: [INT]", sTargeting = "self", sApply = "roll", nDuration = 1, },
		},
	},
	["overchannel"] = {
		actions = {},
	...
	["traininginwarandsong"] = {
		weaponprof = { innate = { "Martial" }, },
		skill = { choice = 1, choice_skill = { "Acrobatics", "Atheltics", "Performance", "Persuasion" }, },
	},
	["songofdefense"] = {
		actions = {},
	},
...
tBuildDataFeat2024 = {
	...
	["boonofthebloodshed"] = {
		multiple_actions = {
			["Killer's Fortune"] = {
				actions = {
					{ type = "effect", sName = "Killer's Fortune (Boon of the Bloodshed); ADV", sTargeting = "self", sApply = "action" },
				},
			},
			["Power from Pain"] = {
				actions = {
					{ type = "effect", sName = "Power from Pain (Boon of the Bloodshed); DMG: [PRF]", sTargeting = "self", sApply = "action" },
				},
			},
		},
	},
	["boonofbountifulhealth"] = {
		multiple_actions = {
			["Augmented Health"] = {
				actions = {
					{ type = "heal", subtype = "temp", sTargeting = "self", clauses = { { dice = {}, bonus = 5, }, }, },
	...
	["boonofdesperateresilience"] = {
		multiple_actions = {
			["Defense of Body and Mind"] = {
				actions = {
					{ type = "effect", sName = "Defense of Body and Mind (Boon of Deperate Resilience); IF: Bloodied; RESIST: all, !force", sTargeting = "self" },
				},
			},
		},
	},
	["boonofpoisonmastery"] = {
		multiple_actions = {
			["Antitoxic"] = {
				actions = {
					{ type = "effect", sName = "Antitoxic (Boon of Poison Mastery); IMMUNE: poisoned, poison", sTargeting = "self" },
				},
			},
		},
	},
	...
	["boonofterror"] = {
		multiple_actions = {
			["Fearless"] = {
				actions = {
					{ type = "effect", sName = "Fearless (Boon of Terror); IMMUNE: frightened", sTargeting = "self" },
				},
			},
			["Flee, Fools!"] = {
				actions = {
		...
		skill = { innate = { "Intimidation" }, prof = "double", },
	},
	["boonofbrightsun"] = {
		multiple_actions = {
			["Fearless"] = {
				actions = {
					{ type = "effect", sName = "Fearless (Boon of Bright Sun); LIGHT: 30 light", sTargeting = "self" },
				},
			},
			["Fortifying Light"] = {
				actions = {
					{ type = "heal", subtype = "temp", sTargeting = "self", clauses = { { dice = {}, bonus = 10, }, }, },
				},
			},
		},
	},
	["boonofthefuriousstorm"] = {
		multiple_actions = {
			["Eye of the Storm"] = {
				actions = {
					{ type = "effect", sName = "Eye of the Storm (Boon of the Furious Storm); RESIST: lightning, thunder", sTargeting = "self" },
					{ type = "effect", sName = "Eye of the Storm (Boon of the Furious Storm); IF: Bloodied; IMMUNE: lightning, thunder", sTargeting = "self" },
				},
			},
		},
	},
	["boonofthesouldrinker"] = {
		multiple_actions = {
			["Grave Resistance"] = {
				actions = {
					{ type = "effect", sName = "Grave Resistance (Boon of the Soul Drinker); RESIST: cold, necrotic", sTargeting = "self" },
				},
			},
			["Siphon Life"] = {
				actions = {
					{ type = "heal", sTargeting = "self", clauses = { { dice = {}, bonus = 50, }, }, },
				},
				prepared = 1,
				usesperiod = "enc",
			},
	...
	["coldcaster"] = {
		...
		multiple_actions = {
			["Frostbite"] = {
				actions = {
					{ type = "effect", sName = "Frostbite (Cold Caster); SAVE: -1d4" },
				},
			},
		},
	},
	["cultofthedragoninitiate"] = {
		language = { innate = { "Draconic" }, },
		multiple_actions = {
			["Dragon's Terror"] = {
				actions = {
					{ type = "powersave", save = "wisdom", savestat = "wisdom" },
					{ type = "effect", sName = "Dragon's Terror (Cult of the Dragon Initiate); Frightened", nDuration = 1, sUnits = "day" },
				},
			},
		},
	},
	["dragonscarred"] = {
		multiple_actions = {
			...
			["Dragon's Terror"] = {
				actions = {
					{ type = "powersave", save = "wisdom", savestat = "wisdom" },
					{ type = "effect", sName = "Dragon's Terror (Dragonscarred); Frightened", nDuration = 1, sUnits = "day" },
				},
			},
		},
	},
	...
	["fairytrickster"] = {
		multiple_actions = {
			["Flustering Strike"] = {
				actions = {
					{ type = "powersave", save = "wisdom", savestat = "wisdom" },
					{ type = "effect", sName = "Flustering Strike (Fairy Trickster); DISSAV", nDuration = 1 },
				},
				prepared = 1,
				usesperiod = "enc",
			},
	...
	["harperagent"] = {
		...
		toolprof = { choice = 1, choice_prof = { "Musical Instrument" }, },
	},
	["lordlyresolve"] = {
		multiple_actions = {
			["Standard Bearer"] = {
				actions = {
					{ type = "effect", sName = "Standard Bearer (Lordly Resolve); IMMUNE: possessed, charmed, frightened" },
				},
				prepared = 1,
				usesperiod = "enc",
			},
	...
	["lordsallianceagent"] = {
		multiple_actions = {
			["Reassert Honor"] = {
				actions = {
					{ type = "effect", sName = "Reassert Honor (Lords' Alliance Agent); ADVATK", sTargeting = "self", sApply = "action" },
				},
			},
		},
	},
	["mythaltouched"] = {
		multiple_actions = {
			["Mythal-Touched Magic (1-2)"] = {
				actions = {
					{ type = "powersave", save = "dexterity", savestat = "dexterity", onmissdamage = "half" },
					{ type = "damage", clauses = { { dice = { "d8" }, dmgtype = "force" }, }, },
				},
				group = "Mythal Ward (Mythal Touched Feat)",
			},
			["Mythal-Touched Magic (8-10)"] = {
				actions = {
					{ type = "powersave", save = "dexterity", savestat = "dexterity" },
				},
				group = "Mythal Ward (Mythal Touched Feat)",
			},
			["Mythal-Touched Magic (11-13)"] = {
				actions = {
					{ type = "powersave", save = "constitution", savestat = "constitution" },
					{ type = "effect", sName = "Mythal-Touched Magic; Stunned", nDuration = 1 },
				},
				group = "Mythal Ward (Mythal Touched Feat)",
			},
			["Mythal-Touched Magic (14-17)"] = {
				actions = {
					{ type = "effect", sName = "Mythal-Touched Magic; AC: 2", nDuration = 1, sUnits = "minute" },
				},
				group = "Mythal Ward (Mythal Touched Feat)",
			},
			["Mythal-Touched Magic (18-19)"] = {
				actions = {
					{ type = "damage", clauses = { { dice = { "d4" }, dmgtype = "fire" }, }, },
				},
				group = "Mythal Ward (Mythal Touched Feat)",
			},
		},
	...
	["ordersresilience"] = {
		multiple_actions = {
			["Stronger Together"] = {
				actions = {
					{ type = "effect", sName = "Stronger Together (Order's Resilience); ADVCHK: strength" },
				},
			},
		},
	},
	["purpledragoncommandant"] = {
		multiple_actions = {
			["Encourage Ally"] = {
				actions = {
					{ type = "heal", subtype = "temp", clauses = { { dice = { "d6", "d6" }, stat = "strength", }, }, },
					{ type = "heal", subtype = "temp", clauses = { { dice = { "d6", "d6" }, stat = "dexterity", }, }, },
				},
				prepared = 1,
				usesperiod = "enc",
			},
			["Last Stand"] = {
				actions = {
					{ type = "effect", sName = "Last Stand (Purple Dragon Commandant); IF: Bloodied; ADVATK", sTargeting = "self" },
				},
			},
		},
	},
	...
	["aberrantdragonmark"] = {
		multiple_actions = {
			...
			["Aberrant Surge (Aberrant Dragonmark)"] = {
				actions = {
					{ type = "heal", subtype = "temp", sTargeting = "self", clauses = { { dice = { "d4", }, }, }, },
					{ type = "heal", subtype = "temp", sTargeting = "self", clauses = { { dice = { "d6", }, }, }, },
					{ type = "heal", subtype = "temp", sTargeting = "self", clauses = { { dice = { "d8", }, }, }, },
					{ type = "heal", subtype = "temp", sTargeting = "self", clauses = { { dice = { "d10", }, }, }, },
					{ type = "heal", subtype = "temp", sTargeting = "self", clauses = { { dice = { "d12", }, }, }, },
					{ type = "damage", clauses = { { dice = { "d4" }, dmgtype = "force" }, }, },
					{ type = "damage", clauses = { { dice = { "d6" }, dmgtype = "force" }, }, },
					{ type = "damage", clauses = { { dice = { "d8" }, dmgtype = "force" }, }, },
					{ type = "damage", clauses = { { dice = { "d10" }, dmgtype = "force" }, }, },
					{ type = "damage", clauses = { { dice = { "d12" }, dmgtype = "force" }, }, },
				},
			},
		},
		spells = {
			...
			["L0"] = 1,
			["L1"] = 1,
			["group"] = "Spells (Aberrant Dragonmark)",
	...
	["markofdetection"] = {
		...
		spells = {
			level = {
				[1] = { "Detect Magic", "Detect Poison and Disease", "Detect Evil and Good", "Identify" },
				[3] = { "See Invisibility", "Detect Thoughts", "Find Traps" },
				[5] = { "Clairvoyance", "Nondetection" },
				[7] = { "Arcane Eye", "Divination" },
				[9] = { "Legend Lore", },
			},
			["group"] = "Spells (Mark of Detection)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	...
	["markoffinding"] = {
		...
		spells = {
			level = {
				[1] = { "Hunter's Mark", "Faerie Fire", "Longstrider" },
				[3] = { "Locate Object","Locate Animals or Plants", "Mind Spike" },
				[5] = { "Clairvoyance", "Speak with Plants" },
				[7] = { "Divination", "Locate Creature" },
				[9] = { "Commune with Nature", },
			},
			["group"] = "Spells (Mark of Finding)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	...
	["markofhandling"] = {
		...
		spells = {
			level = {
				[1] = { "Friendship", "Speak with Animals", "Command", "Find Familiar" },
				[3] = { "Beast Sense", "Calm Emotions" },
				[5] = { "Beacon of Hope", "Conjure Animals" },
				[7] = { "Aura of Life", "Dominate Beast" },
				[9] = { "Awaken", },
			},
			["group"] = "Spells (Mark of Handling)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	...
	["markofhealing"] = {
		...
		spells = {
			level = {
				[1] = { "Cure Wounds", "False Life", "Healing Word" },
				[3] = { "Lesser Restoration", "Arcane Vigor", "Prayer of Healing" },
	...
	["markofhospitality"] = {
		...
		spells = {
			level = {
				[1] = { "Purify Food and Drink", "Unseen Servant", "Goodberry", "Sleep" },
				[3] = { "Calm Emotions", "Aid", "Enhance Ability" },
				[5] = { "Create Food and Water", "Leomund's Tiny Hut" },
				[7] = { "Aura of Purity", "Mordenkainen's Private Sanctum" },
				[9] = { "Hallow", },
			},
			["group"] = "Spells (Mark of Hospitality)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	...
	["markofmaking"] = {
		...
		spells = {
			level = {
				[1] = { "Mending" , "Magic Weapon", "Identify", "Tenser's Floating Disk" },
				[3] = { "Continual Flame", "Spiritual Weapon" },
				[5] = { "Conjure Barrage", "Elemental Weapon" },
				[7] = { "Fabricate", "Stone Shape" },
				[9] = { "Creation", },
			},
			["group"] = "Spells (Mark of Making)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	...
	["markofpassage"] = {
		multiple_actions = {
			["Courier's Speed (Mark of Passage)"] = {
				addspeed = 5,
			},
		...
		spells = {
			level = {
				[1] = { "Misty Step" , "Expeditious Retreat", "Jump", },
				[3] = { "Find Steed", "Pass without Trace" },
				[5] = { "Blink", "Phantom Steed" },
				[7] = { "Dimension Door", "Freedom of Movement" },
				[9] = { "Teleportation Circle", },
			},
			["group"] = "Spells (Mark of Passage)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	...
	["markofscribing"] = {
		...
		spells = {
			level = {
				[1] = { "Message" , "Comprehend Languages", "Command", "Illusory Script" },
				[3] = { "Magic Mouth", "Animal Messenger", "Silence" },
				[5] = { "Sending", "Tongues" },
				[7] = { "Arcane Eye", "Confusion" },
				[9] = { "Dream", },
			},
			["group"] = "Spells (Mark of Scribing)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	...
	["markofsentinel"] = {
		...
		spells = {
			level = {
				[1] = { "Shield" , "Compelled Duel", "Shield of Faith", },
				[3] = { "Warding Bond", "Zone of Truth" },
				[5] = { "Counterspell", "Protection from Energy" },
				[7] = { "Death Ward", "Guardian of Faith" },
				[9] = { "Bigby's Hand", },
			},
			["group"] = "Spells (Mark of Sentinel)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	...
	["markofshadow"] = {
		...
		spells = {
			level = {
				[1] = { "Minor Illusion" , "Invisibility", "Disguise Self", "Silent Image" },
				[3] = { "Darkness", "Pass without Trace" },
				[5] = { "Clairvoyance", "Major Image" },
				[7] = { "Greater Invisibility", "Hallucinatory Terrain" },
				[9] = { "Mislead", },
			},
			["group"] = "Spells (Mark of Shadow)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	...
	["markofstorm"] = {
		multiple_actions = {
			...
			["Storm's Boon (Mark of Storm)"] = {
				{ type = "effect", sTargeting = "self", sName = "Storm's Boon (Mark of Storm); RESIST: lightning", },
			},
		},
		spells = {
			level = {
				[1] = { "Thunderclap" , "Feather Fall", "Fog Cloud" },
				[3] = { "Gust of Wind", "Levitate", "Shatter" },
				[5] = { "Sleet Storm", "Wind Wall" },
				[7] = { "Conjure Minor Elemental", "Control Water" },
				[9] = { "Conjure Elemental", },
			},
			["group"] = "Spells (Mark of Storm)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
	...
	["markofwarding"] = {
		...
		spells = {
			level = {
				[1] = { "Alarm" , "Mage Armor", "Armor of Agayths", "Sanctuary" },
				[3] = { "Arcane Lock", "Knock", "Nystul's Magic Aura" },
				[5] = { "Glyph of Warding", "Magic Circle" },
				[7] = { "Leomund's Secret Chest", "Modenkainen's Faithful Hound" },
				[9] = { "Antilife Shell", },
			},
			["group"] = "Spells (Mark of Warding)",
			["ability"] = "intelligence",
		},
		prepared = 1,
		usesperiod = "enc",
