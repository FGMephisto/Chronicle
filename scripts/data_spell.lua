...
tBuildDataSpell2024 = {
	...
	["alustrielsmooncloak"] = {
		{ type = "effect", sName = "Alustriel's Mooncloak; LIGHT: 20 torch (C)", nDuration = 1, sUnits = "minute" },
		{ type = "effect", sName = "Alustriel's Mooncloak; COVER; RESIST: cold, lightning, radiant (C)", nDuration = 1, sUnits = "minute" },
		{ type = "heal", clauses = { { dice = { "d10", "d10", "d10", "d10" }, } } },
	},
	["bane"] = {
		{ type = "powersave", save = "charisma", magic = true, savebase = "group" },
		{ type = "effect", sName = "ATK: -1d4; SAVE: -1d4; (C)", nDuration = 1, sUnits = "minute" },
	...
	["backlash"] = {
		{ type = "effect", sName = "DMG: -4d6+[INT]", sTargeting = "self", sApply = "action" },
		{ type = "powersave", save = "constitution", onmissdamage = "half", magic = true },
		{ type = "damage", clauses = { { dice = { "d6", "d6", "d6", "d6" }, dmgtype = "force" } } },
	},
	["beaconofhope"] = {
		{ type = "effect", sName = "ADVSAV: wisdom; ADVSAV: death; NOTE: Receive Max Healing; (C)", nDuration = 1, sUnits = "minute" },
	},
	...
	["bladeofdisaster"] = {
		{ type = "attack", range = "M", spell = true, base = "group" },
		{ type = "damage", clauses = { { dice = { "d6", "d6", "d6", "d6", "d6", "d6", "d6", "d6", "d6", "d6" }, dmgtype = "force" } } },
	},
	["bless"] = {
		{ type = "effect", sName = "ATK: 1d4; SAVE: 1d4; (C)", nDuration = 1, sUnits = "minute" },
	},
	...
	["cacophonicshield"] = {
		{ type = "powersave", save = "constitution", magic = true, savebase = "group" },
		{ type = "damage", clauses = { { dice = { "d6", "d6", "d6" }, dmgtype = "thunder" } } },
		{ type = "effect", sName = "Cacophonic Shield; Deafened", nDuration = 1 },
		{ type = "effect", sName = "Cacophonic Shield; RESIST: thunder (C)", sTargeting = "self", nDuration = 10, sUnits = "minute" },
	},
	["calmemotions"] = {
		{ type = "powersave", save = "charisma", magic = true, savebase = "group" },
	...
	["conjureconstructs"] = {
		{ type = "powersave", save = "dexterity", onmissdamage = "half", magic = true, savebase = "group" },
		{ type = "damage", clauses = { { dice = { "d6", "d6", "d6" }, dmgtype = "force" } } },
		{ type = "heal", subtype = "temp", clauses = { { dice = { "d6" }, stat = "intelligence" } } },
	},
	...
	["deatharmor"] = {
		{ type = "damage", clauses = { { dice = { "d4", "d4" }, dmgtype = "necrotic" } } },
	},
	["deathward"] = {
	...
	["dispelevilandgood"] = {
		{ type = "powersave", save = "constitution", onmissdamage = "half", magic = true, savebase = "group" },
		{ type = "damage", clauses = { { dice = { "d10", "d10", "d10" }, dmgtype = "necrotic" } } },
		{ type = "effect", sName = "Prone" },
	},
	["dispelevilandgood"] = {
		{ type = "powersave", save = "charisma", magic = true, savebase = "group" },
	...
	["doomtide"] = {
		...
		{ type = "effect", sName = "Doomtide; SAVE: -1d6", nDuration = 1 },
		{ type = "damage", clauses = { { dice = { "d6", "d6", "d6", "d6", "d6" }, dmgtype = "psychic" } } },
	},
	["dragonsbreath"] = {
		{ type = "powersave", save = "dexterity", onmissdamage = "half", magic = true, savebase = "group" },
	...
	["elminsterseffulgentspheres"] = {
		{ type = "effect", sName = "Elminster's Effulgent Spheres; RESIST: acid", nDuration = 1 },
		{ type = "effect", sName = "Elminster's Effulgent Spheres; RESIST: cold", nDuration = 1 },
		{ type = "effect", sName = "Elminster's Effulgent Spheres; RESIST: fire", nDuration = 1 },
		{ type = "effect", sName = "Elminster's Effulgent Spheres; RESIST: lightning", nDuration = 1 },
		{ type = "effect", sName = "Elminster's Effulgent Spheres; RESIST: thunder", nDuration = 1 },
		{ type = "attack", range = "R", spell = true, base = "group" },
		{ type = "damage", clauses = { { dice = { "d6", "d6", "d6", }, dmgtype = "acid", stat="base", } } },
		{ type = "damage", clauses = { { dice = { "d6", "d6", "d6", }, dmgtype = "cold", stat="base", } } },
		{ type = "damage", clauses = { { dice = { "d6", "d6", "d6", }, dmgtype = "fire", stat="base", } } },
		{ type = "damage", clauses = { { dice = { "d6", "d6", "d6", }, dmgtype = "lightning", stat="base", } } },
		{ type = "damage", clauses = { { dice = { "d6", "d6", "d6", }, dmgtype = "thunder", stat="base", } } },
	},
	["elminsterselusion"] = {
		{ type = "effect", sName = "Elminster's Elusion; ADVSAV: magic; (C)", nDuration = 10, sUnits = "minutes" },
	},
	["enhanceability"] = {
		{ type = "effect", sName = "ADVCHK: strength; (C)", nDuration = 1, sUnits = "hour" },
		{ type = "effect", sName = "ADVCHK: dexterity; (C)", nDuration = 1, sUnits = "hour" },
	...
	["holystarofmystra"] = {
		{ type = "effect", sName = "LIGHT: 5/5 lamp; (C)", nDuration = 1, sUnits = "hour" },
		{ type = "attack", range = "R", spell = true, base = "group" },
		{ type = "damage", clauses = { { dice = { "d10", "d10", "d10", "d10" }, dmgtype = "radiant" }, } },
		{ type = "damage", clauses = { { dice = { "d10", "d10", "d10", "d10" }, dmgtype = "force" }, } },
	},
	["huntersmark"] = {
	...
	["songalselementalsuffusion"] = {
		...
		{ type = "effect", sName = "Songal's Elemental Suffsion; Prone" },
		{ type = "effect", sName = "Songal's Elemental Suffsion; Fly; (C)", sTargeting = "self", nDuration = 1, sUnits = "minute" },
	},
	["sorcerousburst"] = {
		{ type = "attack", range = "R", spell = true, base = "group" },
	...
	["spellfireflare"] = {
		{ type = "attack", range = "R", spell = true, base = "group" },
		{ type = "damage", clauses = { { dice = { "d10", "d10" }, dmgtype = "radiant" } } },
	},
	["spellfirestorm"] = {
		{ type = "powersave", save = "constitution", onmissdamage = "half", magic = true, savebase = "group" },
		{ type = "damage", clauses = { { dice = { "d10", "d10", "d10", "d10" }, dmgtype = "radiant" } } },
	...
	["sylunesviper"] = {
		{ type = "heal", subtype = "temp", clauses = { { bonus = 15 } } },
		{ type = "effect", sName = "Sylune's Viper; Climb Speed 30", sTargeting = "self", nDuration = 1, sUnits = "hour" },
		{ type = "attack", range = "R", spell = true, base = "group" },
		{ type = "damage", clauses = { { dice = { "d6" }, dmgtype = "force" } } },
		{ type = "effect", sName = "Sylune's Viper; Poisoned; Incapacitated", nDuration = 1 },
	},
	["symbol"] = {
		{ type = "powersave", save = "constitution", onmissdamage = "half", magic = true, savebase = "group" },
		{ type = "damage", clauses = { { dice = { "d10", "d10", "d10", "d10", "d10", "d10", "d10", "d10", "d10", "d10" }, dmgtype = "necrotic" } } },
	...
	["wardaway"] = {
		{ type = "powersave", save = "constitution", onmissdamage = "half", magic = true, savebase = "group" },
		{ type = "damage", clauses = { { dice = { "d4", "d4" }, dmgtype = "force" } } },
	},
	["wardingbond"] = {
