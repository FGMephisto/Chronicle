...
function onInit()
	...
	if Session.IsHost then
		...
		CharInventoryManager.registerFieldUpdateCallback("bulk", CharEncumbranceManager5E.calcItemBulk);
...
function onAncestryLinkPressed(nodeChar)
	...
	CharManager.helperOpenLinkRecordFail("race_subrace", sRecord);
	return false;
end
...
function hasTrait(nodeChar, s)
	return ActorManager5E.hasPCTrait(nodeChar, s);
end
function hasFeature(nodeChar, s)
	return ActorManager5E.hasPCFeature(nodeChar, s);
end
function hasFeat(nodeChar, s)
	return ActorManager5E.hasPCFeat(nodeChar, s);
end
function hasFeat2024(nodeChar, s)
	return ActorManager5E.hasPCFeat2024(nodeChar, s);
end
function hasFeat2014(nodeChar, s)
	return ActorManager5E.hasPCFeat2014(nodeChar, s);
end
...
function getClassRecord(nodeChar, s, bSource2024)
	if bSource2024 then
		return ActorManager5E.getListRecordByName2024(nodeChar, "classes", s);
	end
	return ActorManager5E.getListRecordByName2014(nodeChar, "classes", s);
end
function getTraitRecord(nodeChar, s)
	return ActorManager5E.getListRecordByName(nodeChar, "traitlist", s);
end
function getFeatureRecord(nodeChar, s)
	return ActorManager5E.getListRecordByName(nodeChar, "featurelist", s);
end
function getFeatureRecord2014(nodeChar, s)
	return ActorManager5E.getListRecordByName2014(nodeChar, "featurelist", s);
end
function getFeatRecord(nodeChar, s)
	return ActorManager5E.getListRecordByName(nodeChar, "featlist", s);
end
function getFeatRecord2024(nodeChar, s)
	return ActorManager5E.getListRecordByName2024(nodeChar, "featlist", s);
end
function getFeatRecord2014(nodeChar, s)
	return ActorManager5E.getListRecordByName2014(nodeChar, "featlist", s);
end
function getLanguageRecord(nodeChar, s)
	return ActorManager5E.getListRecordByName(nodeChar, "languagelist", s);
end
...
function addSkillHalfProficiency(nodeChar, s)
	local nodeSkill = CharManager.getSkillRecord(nodeChar, s, true);
	if not nodeSkill then
		return nil;
	end
	...
	DB.setValue(nodeSkill, "prof", "number", 3);
	return nodeSkill;
end
