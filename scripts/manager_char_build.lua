...
function getSkillsFromText2024(s)
	...
	-- EFOTA - Species - Khoravar
	local sPicks = s:match("[Pp]roficiency in one skill or with one tool of your choice");
	if sPicks then
		return {}, {}, 1;
	end

	-- EFOTA - Species - Warforged
	local sPicks = s:match("gain one skill [Pp]roficiency and one tool [Pp]roficiency of your choice");
	if sPicks then
		return {}, {}, 1;
	end
