...
function registerOptions()
	...
	OptionsManager.registerOptionData({	
		...
		tCustom = { labelsres = "record_label_2024", values = "2024", baselabelres = "record_label_2014", baseval = "record_label_version", default = "2014", },
	});
	...
	OptionsManager.registerOptionData({	
		sKey = "NPCD", sGroupRes = "option_header_combat",
